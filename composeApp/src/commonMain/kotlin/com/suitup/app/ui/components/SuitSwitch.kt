...
fun SuitSwitch(
    ...
    Switch(
        ...
        colors = SwitchDefaults.colors(
            checkedThumbColor = SuitColors.GoldInk,
            checkedTrackColor = SuitColors.Gold,
            checkedBorderColor = SuitColors.Gold,
            uncheckedThumbColor = SuitColors.Ink,
            uncheckedTrackColor = SuitColors.SurfaceHigh,
